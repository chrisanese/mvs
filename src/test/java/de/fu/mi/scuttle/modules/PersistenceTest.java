...
public class PersistenceTest {
    ...
    private final static String jdbcUrl = "jdbc:derby:memory:scuttle";
    ...
    private final static String persistenceUnit = "scuttle";
    ...
    public void testCreatePersistenceUnit() throws SQLException {
        ...
        List<Object> tables = em
                ...
                .getResultList();
        for (Object o : tables) {
            actualTables.add(o.toString().toLowerCase());
        }
